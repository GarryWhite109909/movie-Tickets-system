...
## Overview
The backend API (`apps/server_nest`) provides endpoints for Film listing, Film details, and User Login. The current Web Frontend (`apps/web_new`) has a Home page and a basic Film list.
